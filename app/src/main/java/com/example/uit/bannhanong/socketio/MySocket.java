package com.example.uit.bannhanong.socketio;
...
public class MySocket {
    ...
    public void connectSocket() {
        ...
        try {
            String api = "http://192.168.38.1:3000";

            mSocket = IO.socket(/*MainApplication.getContext().getString(R.string.base_url)*/api + "/?token=" + userPref.getUser().token);
